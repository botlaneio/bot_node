...
export const ApplicationModal: React.FC<ApplicationModalProps> = ({ isOpen, onClose }) => {
  ...
  const triggerConfetti = () => {
    confetti({
      ...
      spread: 60,
      origin: { y: 0.6 },
      colors: ['var(--sheet-ink)', '#3f3f46', '#71717a', '#a1a1aa', '#e4e4e7'],
      ticks: 200,
      gravity: 1.1,
      scalar: 0.85,
      ...
      <div className="bg-white rounded-2xl border border-[#E5E5E0] shadow-2xl max-w-lg w-full p-6 sm:p-8 relative text-zinc-900">
        ...
        {!submitted ? (
          ...
          <div className="text-center py-6 space-y-4">
            <div className="w-12 h-12 rounded-full bg-[var(--sheet-ink)] text-[#fafafa] flex items-center justify-center mx-auto">
